<div class="d-flex flex-column flex-column-fluid">
                    ...
                    <div
                        ...
                        <div class="d-flex flex-column">
                            <span class="fw-bold fs-5">
                                Acontinuación se muestra la lista de roles que tiene el sistema.
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-toolbar">
                                <button type="button" class="btn btn-light-primary" data-bs-toggle="modal"
                                    wire:click="modo" data-bs-target="#modal-rol">
    ...
    <div class="modal fade" tabindex="-1" id="modal-rol" wire:ignore.self>
                    ...
                    <div class="modal-body row g-5"">
                        <div class=" col-md-12">
                            ...
                            <input type="text" wire:model="nombre"
                                ...
                                placeholder="Ingrese el nombre del rol" id="nombre" />
                            @error('nombre')
                            ...
                            <div class="row g-5">
                                ...
                                @foreach ($permisos as $item)
                                    <div class="col-md-3 col-sm-6">
                                        <div class="form-check" wire:key="{{ $item->id }}">
                                            <input class="form-check-input" type="checkbox" wire:model.live="permiso"
